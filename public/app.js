...
async function startScreen(){
  try{
    ...
    screenStream=await navigator.mediaDevices.getDisplayMedia({video:{width:{ideal:Math.round(h*16/9)},height:{ideal:h},frameRate:{ideal:f,max:f}},audio:{echoCancellation:false,noiseSuppression:false,autoGainControl:false}});
